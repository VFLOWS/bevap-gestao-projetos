...
function afterTaskCreate(colleagueId) {
    try {
        ...
        log.info("[GP][" + GP_PROCESS_NAME + ".afterTaskCreate] Evento recebido: colleagueId=" + text(colleagueId) +
            ", WKNumProces=" + workflowValue("WKNumProces") +
            ", WKDef=" + workflowValue("WKDef") +
            ", WKNextState=" + workflowValue("WKNextState") +
            ", WKNumState=" + workflowValue("WKNumState") +
            ", atividadeResolvida=" + activity + ".");
...
function getNotifyConfig(activity) {
    var configs = {
        "15": { type: "user", field: "solicitanteColleagueIdNS", correction: true, route: "correction" },
        "19": { type: "user", field: "aprovadorSuperiorImedNS", route: "immediateApproval" },
        "26": { type: "group", target: "TI", route: "technicalTriage" },
        "28": { type: "group", target: "TI", route: "glpiErrorTreatment" },
        "36": { type: "group", target: "COMITE_GP", route: "committeeApproval" },
        "38": { type: "group", target: "TI", route: "commercialProposal" },
        "40": { type: "user", field: "solicitanteColleagueIdNS", route: "requesterProposalApproval" },
        "54": { type: "user", field: "aprovadorSuperiorImedNS", route: "gccCostApproval" },
        "61": { type: "group", target: "COMITE_GP", route: "committeeCostApproval" },
        "66": { type: "group", target: "COMPRAS", route: "purchaseContracting" },
        "74": { type: "group", target: "TI", route: "technicalTriage" }
    };
