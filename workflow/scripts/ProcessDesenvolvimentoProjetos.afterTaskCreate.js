...
function getNotifyConfig(activity) {
    var configs = {
        "14": { type: "group", target: "TI", route: "projectPlanning" },
        "18": { type: "group", target: "TI", route: "projectExecution" },
        "23": { type: "user", field: "solicitanteColleagueIdNS", route: "projectRequesterValidation" },
        "32": { type: "group", target: "TI", route: "projectTiValidation" },
        "46": { type: "group", target: "TI", route: "dpGlpiErrorTreatment" },
        "47": { type: "group", target: "TI", route: "dpStartExecErrorTreatment" },
        "52": { type: "group", target: "TI", route: "dpGlpiErrorTreatment" },
        "56": { type: "group", target: "TI", route: "dpStartDeliveryErrorTreatment" }
    };
