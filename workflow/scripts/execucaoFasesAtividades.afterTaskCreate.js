...
function getNotifyConfig(activity) {
    var configs = {
        "14": { type: "group", target: "TI", route: "executionActivityWaiting" },
        "18": { type: "group", target: "TI", route: "executionActivity" },
        "23": { type: "user", field: "solicitanteColleagueIdNS", route: "executionActivityRequesterValidation" },
        "32": { type: "group", target: "TI", route: "executionActivityTiValidation" },
        "46": { type: "group", target: "TI", route: "efGlpiErrorTreatment" },
        "52": { type: "group", target: "TI", route: "efGlpiErrorTreatment" }
    };
