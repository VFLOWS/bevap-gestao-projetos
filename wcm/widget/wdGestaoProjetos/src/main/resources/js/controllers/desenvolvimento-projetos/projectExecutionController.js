var projectExecutionController = {
  ...
  ensureActionAccess: async function (params) {
    ...
    console.log('[GP][projectExecutionAccess] validando acesso:', params);

    var access = await fluigService.resolveProjectActionAccess('projectExecution', params || {});
    ...
    var message = access && access.message ? access.message : 'Você não tem permissão para atuar nessa solicitação.';
    if (typeof router !== 'undefined' && router.showActionAccessDeniedModal) {
