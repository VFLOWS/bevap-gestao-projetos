function createDataset(fields, constraints, sortFields) {
	...
	if (constraints != null) {
		for (var c = 0; c < constraints.length; c++) {
			...
			if (constraints[c].fieldName == "CODCFO") {
				filtro += " AND CODCFO = '" + constraints[c].initialValue + "'";
			}
		}
	}
	
	var context = "CODUSUARIO=svc.totvs.fluig;CODSISTEMA=V;CODCOLIGADA=" + CODCOLIGADA
	

	var retorno = dcReadView("FinCFOContatoDataBR", context, usuario, senha, filtro)

	log.info("dsGetContatoForn_ReadView - retorno: ")
	log.info(retorno)
