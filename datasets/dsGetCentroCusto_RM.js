function createDataset(fields, constraints, sortFields) {
    ...
    var cSql = "select * from GCCUSTO C where c.ATIVO = 'T' AND LEN(C.CODCCUSTO) > 9 AND C.CODCCUSTO NOT LIKE '0.%' AND C.CODCLASSIFICA IS NOT NULL AND C.CODCOLIGADA = " + CODCOLIGADA + " ";
