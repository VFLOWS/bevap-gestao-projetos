(function () {
    ...
    function renderGoLiveCards() {
        ...
        var planningHtml = goLivePlanningData.map(function (item, planningIndex) {
            ...
            var canEditResolvedStatus = isDuringGoLive && item.planningStatus === 'realizado' && !item.isEditingStatus;
            var canShowStatusFlag = (isPreGoLive && item.planningStatus === 'planejado') || (isDuringGoLive && (item.planningStatus === 'planejado' || item.isEditingStatus));
            var statusFlag = '';
