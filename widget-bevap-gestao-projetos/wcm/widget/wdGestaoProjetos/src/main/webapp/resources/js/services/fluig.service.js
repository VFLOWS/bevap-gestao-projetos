...
var fluigService = {
    ...
    buildProjectProcessContext: function (processType, row, extras) {
        ...
        var privacyDefaults = this.getProjectPrivacyDefaults(finalRow, finalExtras);
        ...
        return Object.assign({}, finalRow, finalExtras, privacyDefaults, {
    ...
    getProjectPrivacyDefaults: function (row, extras) {
        var source = Object.assign({}, row || {}, extras || {});
        var defaults = {};

        ['projetoPrivadoNS', 'projetoPrivadoAPTI', 'projetoPrivadoAtualGP'].forEach(function (fieldName) {
        ...
        var participants = source.participantesProjetoNS;
        if (participants === null || participants === undefined || String(participants).trim() === '' || String(participants).trim().toLowerCase() === 'null') {
            defaults.participantesProjetoNS = '[]';
        }
